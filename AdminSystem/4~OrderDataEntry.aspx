...
<body style="height: 599px">
    &nbsp;<form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="lblOrderNo" runat="server" style="z-index: 1; left: 10px; top: 18px; position: absolute; right: 923px; height: 27px;" Text="Order Number"></asp:Label>
        </p>
        ...
        <asp:TextBox ID="txtNoOfCases" runat="server" height="22px" style="z-index: 1; left: 172px; top: 164px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtProductID" runat="server" height="22px" style="z-index: 1; left: 172px; top: 128px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtDateAdded" runat="server" height="22px" style="z-index: 1; left: 172px; top: 204px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtAddressID" runat="server" height="22px" style="z-index: 1; left: 171px; top: 93px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtCustomerID" runat="server" height="22px" style="z-index: 1; left: 171px; top: 56px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtOrderNo" runat="server" height="22px" style="z-index: 1; left: 170px; top: 17px; position: absolute"></asp:TextBox>
        ...
        <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 347px; top: 17px; position: absolute; width: 49px" Text="Find" />
    </form>
</body>
</html>
