...
<body style="height: 599px">
    &nbsp;<form id="form1" runat="server">
        ...
        <p>
            <asp:Label ID="lblOrderNo" runat="server" height="22px" style="z-index: 1; left: 10px; top: 18px; position: absolute; right: 1250px" Text="Order Number"></asp:Label>
        </p>
        ...
        <asp:Label ID="lblProductID" runat="server" height="22px" style="z-index: 1; left: 10px; top: 129px; position: absolute" Text="Product"></asp:Label>
